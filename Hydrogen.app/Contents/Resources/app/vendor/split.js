  ...
  , Split = function (ids, options) {
    ...
    var startDragging = function (e) {
      ...
      , adjust = function (offset) {
            ...
            if (aSize < 1) {
                this.a.style[dimension] = 0;
                this.b.style[dimension] = 'calc(100% - ' + (this.aGutterSize + this.bGutterSize) + 'px)';
                return
            }

            if (bSize < 1) {
                this.b.style[dimension] = 0;
                this.a.style[dimension] = 'calc(100% - ' + (this.aGutterSize + this.bGutterSize) + 'px)';
                return
            }
